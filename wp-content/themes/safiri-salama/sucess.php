 ...
 */
 $mpesa1 = $wpdb->get_results("SELECT * FROM wp_tribute where `status`= 1 order by id desc limit 1");
...
<head>
    <meta http-equiv="refresh" content="3;url=<?php echo get_site_url(); ?>/login" />
