...
get_header();
/**
 * Template Name: after create pricing
 **/
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <a href="" class="cancel">cancel</a>
        <a href="<?php echo get_site_url(); ?>/payment/?plan=4" class="proceed blue_bg">proceed</a>
      </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h3><?php echo get_field('premium_price'); ?>.<span>00</span></h3>
        <a href="" class="cancel">cancel</a>
        <a href="<?php echo get_site_url(); ?>/payment/?plan=5" class="proceed">proceed</a>
      </div>
